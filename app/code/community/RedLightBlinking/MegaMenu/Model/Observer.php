        ...
        if ($category && $category->getLevel() == 2) {
            ...
            foreach ($elements as $element) {
                if ($element instanceof Varien_Data_Form_Element_Fieldset) {
                    if ($element->getLegend() == Mage::helper('catalog')->__("Display Settings")) {
                        // $storeId = getStoreFromCategory() // TODO
                        $categoryId = $category->getId();
                        $url = Mage::getModel('adminhtml/url')->getUrl(
                            'adminhtml/redLightBlinkingMegaMenu_staticBlock/index',
                        ...
                        $element->addField(
                            ...
                            array(
                                ...
                                'note' => 'save your changes on this category before ' .
                                    ($megaMenuBlockId ? 'editing' : 'creating') .
                                    ' the mega menu static block',
